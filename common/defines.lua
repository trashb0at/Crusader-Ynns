...
NCharacter = {
	...
	EARLY_PORTRAIT_AND_UNIT_BEFORE_YEAR = 1400,		-- Before this date, early versions of Units and Portraits will be used if available
	LATE_PORTRAIT_AND_UNIT_AFTER_YEAR = 1600,		-- After this date, late versions of Units and Portraits will be used if available
...
NTechnology = {
	...
	IDEAL_YEAR_LEVEL_0 = 1105, 					-- the chance to get a progress to this level will increase after this date and decrease before it
	IDEAL_YEAR_LEVEL_8 = 1805,
